AI Rules
Lido automaticamente pelo Dyad a cada prompt. Mantenha este arquivo curto e direto — regras longas diluem as importantes. Detalhes de arquitetura estão em docs/frontend.md, docs/backend.md e nos README.md de cada contexto em src/contexts/.
...
Leia este AI_RULES.md primeiro.
Identifique o contexto funcional em src/contexts/<nome>/.
Se o contexto ainda não existir, crie a estrutura inicial completa do contexto, incluindo README.md.
Leia o README.md do contexto relevante antes de editar código.
Consulte apenas a seção necessária dos guias abaixo, usando o Índice Operacional no topo de cada arquivo:
...
Se a tarefa for full-stack, consulte os dois guias.
Ao finalizar mudanças de arquitetura, atualize o README.md do contexto.
Regra prática:
